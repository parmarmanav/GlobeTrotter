...
const seedData = async () => {
  try {
    ...
    // 2. Seed Destination Cities (2-3 per global region)
    const sampleCities = [
      // Europe (3)
      {
        name: 'Paris',
        country: 'France',
        region: 'Europe',
        description: 'The City of Light known for world-class art museums, grand boulevards, and gourmet cuisine.',
      ...
      },
      {
        ...
        country: 'Italy',
        region: 'Europe',
        description: 'The Eternal City with nearly 3,000 years of globally influential art, architecture, and trattorias.',
      ...
      },
      {
        ...
        country: 'Spain',
        region: 'Europe',
        description: 'Catalonian coastal gem famous for Antoni Gaudí architecture, Gothic quarters, and sandy beaches.',
        image: 'https://images.unsplash.com/photo-1583422409516-2895a77efded',
        costIndex: 3,
        popularityScore: 94,
        tags: ['beach', 'gaudi', 'tapas', 'architecture', 'nightlife']
      },
      // Asia (3)
      {
        name: 'Tokyo',
        country: 'Japan',
        region: 'Asia',
        description: 'A vibrant metropolis blending ultra-modern neon-lit skyscrapers with historic temples and Michelin dining.',
      ...
      },
      {
        ...
        country: 'Indonesia',
        region: 'Asia',
        description: 'An Indonesian island paradise known for emerald rice terraces, cliffside temples, and surf beaches.',
      ...
      },
      {
        ...
        country: 'Thailand',
        region: 'Asia',
        description: 'Dynamic capital known for ornate royal shrines, floating longtail boat markets, and street food.',
        image: 'https://images.unsplash.com/photo-1508009603885-50cf7c579365',
        costIndex: 2,
        popularityScore: 93,
        tags: ['temples', 'food', 'nightlife', 'markets', 'culture']
      },
      // Americas (3)
      {
        name: 'New York',
        country: 'USA',
        region: 'Americas',
        description: 'The premier global hub for finance, Broadway theater, world-class museums, and skyline views.',
      ...
      },
      {
        ...
        country: 'Brazil',
        region: 'Americas',
        description: 'Vibrant seaside city framed by Christ the Redeemer, Sugarloaf Mountain, and Copacabana beach.',
        image: 'https://images.unsplash.com/photo-1483729558449-99ef09a8c325',
        costIndex: 3,
        popularityScore: 91,
        tags: ['beach', 'samba', 'nature', 'carnival', 'views']
      },
      {
        name: 'Vancouver',
        country: 'Canada',
        region: 'Americas',
        description: 'Pacific Northwest wonderland surrounded by snowcapped mountains, rainforest parks, and seaside seawalls.',
        image: 'https://images.unsplash.com/photo-1559511260-66a65e09b245',
        costIndex: 4,
        popularityScore: 90,
        tags: ['nature', 'mountains', 'coastal', 'hiking', 'parks']
      },
      // Africa (3)
      {
        name: 'Cape Town',
        ...
        region: 'Africa',
        description: 'Port city under the majestic Table Mountain, featuring dramatic coastal peninsulas and wildlife colonies.',
        image: 'https://images.unsplash.com/photo-1580618672591-eb180b1a973f',
        costIndex: 2,
        popularityScore: 92,
        tags: ['nature', 'table-mountain', 'ocean', 'penguins', 'hiking']
      },
      {
        name: 'Cairo',
        country: 'Egypt',
        region: 'Africa',
        description: 'Ancient powerhouse on the Nile with the Great Pyramids of Giza, Sphinx, and historic Islamic quarters.',
        image: 'https://images.unsplash.com/photo-1572252009286-268acec5ca0a',
        costIndex: 2,
        popularityScore: 93,
        tags: ['pyramids', 'history', 'nile', 'monuments', 'ancient']
      },
      {
        name: 'Marrakech',
        country: 'Morocco',
        region: 'Africa',
        description: 'Historic former imperial city known for bustling souk labyrinths, Moorish palaces, and riad gardens.',
        image: 'https://images.unsplash.com/photo-1597212618440-806262de4f6b',
        costIndex: 2,
        popularityScore: 91,
        tags: ['souks', 'desert', 'palaces', 'culture', 'architecture']
      },
      // Oceania (2)
      {
        name: 'Sydney',
        country: 'Australia',
        region: 'Oceania',
        description: 'Harbour city celebrated for the Sydney Opera House sails, Harbour Bridge, and Bondi coastal walks.',
        image: 'https://images.unsplash.com/photo-1506973035872-a4ec16b8e8d9',
        costIndex: 4,
        popularityScore: 95,
        tags: ['opera-house', 'harbour', 'beaches', 'surfing', 'nature']
      },
      {
        name: 'Auckland',
        country: 'New Zealand',
        region: 'Oceania',
        description: 'City of Sails centered around two large harbours, dormant volcanic cones, and lush rainforest beaches.',
        image: 'https://images.unsplash.com/photo-1507699622108-4be3abd695ad',
        costIndex: 4,
        popularityScore: 89,
        tags: ['sailing', 'volcanoes', 'islands', 'nature', 'adventure']
      }
    ];
